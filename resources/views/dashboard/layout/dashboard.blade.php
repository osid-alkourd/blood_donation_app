...
<head>
    ...
    <link href="{{ asset('fontapi.css') }}" rel="stylesheet">
    <!-- Bootstrap 4 RTL -->
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">التبرع بالدم</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                            <a href="#" class="nav-link active">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('dashboard.donation_offers') }}" class="nav-link">
                                        <p>جميع عروض التبرع</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('dashboard.appeals') }}" class="nav-link">
                                        <p>جميع مناشدات التبرع</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('dashboard.campaigns') }}" class="nav-link">
                                        <p>جميع حملات التبرع</p>
                                    </a>
                                </li>
                        
                       
                        <li class="nav-item">
                            <a href="{{ route('dashboard.campaigns.create') }}" class="nav-link">
                                <p>انشاء حملة تبرع</p>
                            </a>
                        </li>
